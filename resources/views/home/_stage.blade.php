...
<div class="flex-1 flex flex-col items-center justify-start bg-gradient-to-b from-slate-900 to-slate-950 relative overflow-y-auto px-4 py-10 min-h-[280px]">
    ...
    <div class="flex flex-wrap gap-3 justify-center items-start relative z-10 w-full max-w-4xl px-2">
        <template x-for="(slot, i) in slots" :key="'slot-'+i">
            <div
                class="relative rounded-2xl border-2 transition-all duration-200 overflow-hidden flex-shrink-0 w-[130px] h-[150px]"
            ...
            >
                ...
                <template x-if="!slot">
                    <div class="absolute inset-0 flex flex-col items-center justify-center gap-2">
                        <div class="text-slate-500 font-light select-none leading-none" style="font-size:3rem">+</div>
